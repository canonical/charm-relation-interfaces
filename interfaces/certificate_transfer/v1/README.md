...
- Is expected to provide a list of public certificate and/or a CA certificate and/or a CA chain.

### Requirer

- Is expected to use the provided certificates and/or CA certificates and/or chains to authenticate communications.
...
The provider writes any number of certficate, CA certificate and CA chain in its unit relation data.
